...
def train_model(model, dataloaders, criterion, optimizer, num_epochs, learning_rate):
    ...
    for epoch in range(num_epochs):
        print(f'Epoch {epoch+1}/{num_epochs} - LR: {learning_rate}')
        print('-' * 30)
...
def main():
    ...
    for lr in learning_rates:
        ...
        model_path = f'./models/mobilenet_lr_{lr}.pth'
        torch.save(trained_model.state_dict(), model_path)
        print(f'Model saved to {model_path}')

        # Plot and save the training curves
        fig_name = f'training_curve_lr_{lr}.png'
